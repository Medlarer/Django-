...
class CustomerDistribution(models.Model):
    ...
    客户分配表
    """
    user = models.ForeignKey(to="UserInfo", limit_choices_to={"depart_id": 1001}, verbose_name="客户顾问",related_name="cds")
    customer=models.ForeignKey(to="Customer",verbose_name="客户",related_name="dealer")
    ...
    status=models.IntegerField(choices=status_choices,default=1,verbose_name="客户状态")
...
class SaleRank(models.Model):
    ...
    销售权重表
    """
    user=models.ForeignKey(to="UserInfo",limit_choices_to={"depart_id":[1001,]},verbose_name="销售")
